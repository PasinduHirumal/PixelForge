      ...
      <div
        ...
        className={cn(
          ...
          isDragActive || isDragActiveLocal
            ...
            : "border-zinc-800 hover:border-indigo-900 bg-zinc-900/30",
      ...
      >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-5 z-10">
            ...
            <div>
              <p className="font-semibold text-zinc-900 text-zinc-100">
                {isDragActive || isDragActiveLocal
                  ? "Drop your image here"
                  : "Drag & drop image here, or click to browse"}
              </p>
              <p className="text-zinc-500 text-zinc-400 mt-2 max-w-sm">
        ...
        {error && (
          <motion.div
            ...
            className="absolute bottom-4 flex items-center gap-2 px-4 py-2 rounded-full bg-rose-950/20 text-rose-400 text-xs font-medium border border-rose-950/30"
          >
